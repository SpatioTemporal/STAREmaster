// This header contains error codes for the entire STARE sidecar file
// project.

// Ed Hartnett 4/5/20

#define SSC_EHDF4ERR 1000
#define SSC_ENETCDF  1001
#define SSC_ENOMEM   1002
#define SSC_EINPUT   1003

#define SSC_DEFAULT_BUILD_LEVEL 5

#define SSC_FORMAT_HDF4 1
#define SSC_FORMAT_HDF5 2
#define SSC_FORMAT_NETCDF 3
#define SSC_FORMAT_MODIS_L2 4
