...
# Remove line 22, which has the history attribute, containing date/time.
...
../src/createSidecarFile -i "Institute for the Study of Institutes" data/MOD05_L2.A2005349.2125.061.2017294065400.hdf
...
# Remove line 23, which has the history attribute, containing date/time.
sed '23d' MOD05_L2.A2005349.2125.061.2017294065400_stare_inst_out.cdl > MOD05_L2.A2005349.2125.061.2017294065400_stare_no_hist_inst_out.cdl
